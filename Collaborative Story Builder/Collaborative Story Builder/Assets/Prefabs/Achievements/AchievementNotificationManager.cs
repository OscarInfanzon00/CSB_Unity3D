...
using TMPro;
public class AchivementNotificationManager : MonoBehaviour
{
    ...
    public static AchivementNotificationManager Instance;
    ...
    public void Notify(string name, string description, float? duration = null)
    {
        if (NameText == null || canvasGroup == null)
        {
